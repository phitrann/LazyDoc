...
class Settings:
    ...
    enable_long_cache: bool = os.getenv("ENABLE_LONG_CACHE", "false").lower() in ("true", "1", "yes")
    long_cache_ttl_seconds: int = int(os.getenv("LONG_CACHE_TTL_SECONDS", "86400"))
    ...
    local_llm_base_url: str = os.getenv("LOCAL_LLM_BASE_URL", "http://localhost:9898/v1")
